...
measured experimentally, which is slow and expensive. A computational alternative
that is both accurate and cheap would let new compositions be tested before
any metal is cast.
...
A part is designed based on two numbers. Young's modulus $E=\sigma/\varepsilon$
...
contracts sideways while it elongates. For a cubic crystal both reduce to the two
...
target of this project, sit near $70$\,GPa with $\nu\approx0.30$.
...
\subsection{Physics Background: Interatomic Potentials and Density Functional Theory}
...
The reference data that the MEAM parameters are fit against in this project will come from density
...
Quantum Espresso \citep{giannozzi2009}. From the DFT, the project takes the cohesive
...
supplies the small, trustworthy reference set against which the computationally cheap potential
is calibrated.
