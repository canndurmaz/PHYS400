...
The honest weakness is everything outside that region, where the refit
potential turns mechanically unstable (Section~\ref{sec:nnip}). The remaining
work is therefore about three things: making the optimization better posed,
widening the chemistry it can cover, and tightening the reference data behind
it.

\subsection{Upcoming Objectives}

\paragraph{A better-posed optimization.}
The refit currently moves on the order of $200$ cross-term parameters at once,
...
parameter count to a tractable few. The Born--Cauchy stability conditions,
...
For the cross-terms specifically, special quasi-random structure references
...
\begin{itemize}
	...
	\item \textbf{Inverse Optimization (W8--W13).} L-BFGS back-propagation
