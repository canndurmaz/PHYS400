...
The 3$d$ transition metals Fe, Cr, and Mn need spin polarisation, and a plain
...
Mn, Mo) and 40 binary pairs. The fitted elemental properties are listed in
...
The 40 binary formation energies $E_\mathrm{form}(i,j)$ are summarised as a
