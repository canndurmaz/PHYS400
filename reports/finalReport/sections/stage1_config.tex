...
single JSON object. It holds the species composition (mass fractions that sum
to unity at $10^{-4}$ precision), the simulation box edge in metres, the target
...
forced to be the majority species whenever it appears in a draw. In total,
$7879$ configuration records were generated. Of those, $7815$ survive the
Stage~2 physicality filter described in Section~\ref{sec:stage2}, and that
